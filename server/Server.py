...
parser.add_argument('--ipBoot', '-i', type=str, help="IP of the multimedia content server", required=False)
parser.add_argument('--portBoot', '-p', type=int, help="Port of the multimedia content server", required=False)
parser.add_argument('--rtpPort', '-r', type=int, help="Port of the multimedia server that is running", required=False)
parser.add_argument('--ipRootNode', '-n', type=str, help="Port of the multimedia server that is running", required=False)
parser.add_argument('--filename', '-f', type=str, help="Port of the multimedia server that is running", required=True)
